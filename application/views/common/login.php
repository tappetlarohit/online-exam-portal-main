                ...
                <div class="row  login_sec_main">
                    <div class="col-md-6">
                        <div class="login_left">
                            <img src="<?php echo base_url();?>student_assets/images/login.webp" alt="" width="100%">
                        </div>
                    </div>
                    <div class="col-md-6">
                                <?php 
                        ...
                        <div class="login_form">
                            <form action="<?php echo base_url('common/auth');?>" method="POST">
                            <b>User Login</b><br><br>
                                ...
                                <div class="btn_sec">
                                    <button type="submit" class="btn btn-success"style="float: left;" > login </button> 
